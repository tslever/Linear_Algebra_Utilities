...
public class MysterySort
{
	...
	private static final int THE_MAXIMUM_INTEGER = 2147483647;
    ...
    public static void main( String[] args ) throws AnInvalidArraySizeException, AnIntegerOverflowException
    {
    	...
    	{
    		//theArrayToSort[i] = TheRandomNumberGenerator.getARandomIntegerInclusivelyBetween(0, THE_MAXIMUM_INTEGER - 1);
    	...
    	printWhetherOrNotIsSorted(theArrayToSort);
    ...
    private static void printWhetherOrNotIsSorted(int[] theArray)
    {
    	System.out.println("The array " + ((isSorted(theArray)) ? "is " : "is not ") + "sorted.");
    }
