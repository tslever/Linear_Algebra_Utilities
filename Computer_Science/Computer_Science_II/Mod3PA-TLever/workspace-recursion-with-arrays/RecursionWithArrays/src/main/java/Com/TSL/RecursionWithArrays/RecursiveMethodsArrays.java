...
* Completion date: 06/03/21
*/


/** *******************************************************************************************************************
 * RecursiveMethodsArrays encapsulates the entry point of this program, which tests methods to find the minimum integer
 * in a one-dimensional array of integers, to find the minimum integer in a one-dimensional array of one-dimensional
 * arrays of integers, and to concatenate a number of instances of an input string.
 * 
 * @author Tom Lever
 * @version 1.0
 * @since 06/04/21
...
public class RecursiveMethodsArrays
{
	...
	/** ---------------------------------------------------------------------------------------------------------------
	 * main is the entry point of this program, which tests methods to find the minimum integer in a one-dimensional
	 * array of integers, to find the minimum integer in a one-dimensional array of one-dimensional arrays of integers,
	 * and to concatenate a number of instances of an input string.
	 * 
	 * @param args
    ...
    public static void main (String[] args) throws ANoMinimumExistsException, IllegalArgumentException
    {
        ...
        System.out.println (repeat ("I", 34));
    ...
    * @return
    ...
    static boolean isPowerOfTwo (int theInteger)
    {
    	if (theInteger <= 0)
    	{
    		return false;
    	...
    	return isPowerOfTwo (theInteger / 2);
