...
public class DeckOfCards
{
    ...
    public Card dealACard() throws ADealFromAnEmptyDeckException
    {
        ...
        Card theCardToDeal = this.array_of_cards[this.numberOfCards];
    ...
    public void setToTheDefaultState()
    {
        final int THE_MAXIMUM_NUMBER_OF_CARDS_IN_A_DECK = 52;
        final int NUM_FACES = 13;
        final int NUM_SUITS = 4;
        
        this.array_of_cards = new Card[THE_MAXIMUM_NUMBER_OF_CARDS_IN_A_DECK];
        ...
        for (int i = 0; i < NUM_FACES; i++)
        {
            ...
            {
                this.array_of_cards[NUM_SUITS * i + j] = new Card(i + 1, j + 1);
            }
        }
    ...
    public void shuffle()
    {
        ...
        ArrayUtils.shuffle(this.array_of_cards);
    }
